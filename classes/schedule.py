...
class Schedule:
    variable_name_format = "Individual_{tag}_Period_{period}_Course_{course}"
    ...
    def createVariableName(self, tag, period, course):
        ...
        return self.variable_name_format.format(tag=tag, period=period, course=course)
    ...
    def parseVariableName(self, variable_name):
        ...
        template_tokens = self.variable_name_format.split("_")
